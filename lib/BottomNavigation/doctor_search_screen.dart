              ...
              child: Column(
                ...
                children: [
                  ...
                  loaderController.dataLoader
                      ...
                      : loaderController.getDoctorFromSearchModel.data == null
                      ? SizedBox()
                      : Expanded(
                    child: ListView(
                      children: List.generate(loaderController.getDoctorFromSearchModel.data.length, (index) {
                        return loaderController.getDoctorFromSearchModel.data[index].status==1?Padding(
                          ...
                          child: InkWell(
                            onTap: (){
                              Get.to(DoctorInfo(
                              docId: loaderController.getDoctorFromSearchModel.data[index].id,
                              ));
                            },
                            child: Container(
                              height: 80,
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              image:  AssetImage(
                                                'assets/FooterIcons/ic_doctors.png',
                                              ),)),
                                    ),
                                    SizedBox(
                                      width: 8,
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${loaderController.getDoctorFromSearchModel.data[index].name}',
                                            softWrap: true,
                                            overflow:
