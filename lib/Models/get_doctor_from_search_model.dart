...
class GetDoctorFromSearchModel {
  List<GetDoctorFromSearchModelData> _data;
  bool _status;
  int _success;
  String _message;

  List<GetDoctorFromSearchModelData> get data => _data;
  bool get status => _status;
  int get success => _success;
  String get message => _message;

  GetDoctorFromSearchModel({
    List<GetDoctorFromSearchModelData> data,
    bool status,
    int success,
    String message}){
    _data = data;
  ...
  GetDoctorFromSearchModel.fromJson(dynamic json) {
    if (json["data"] != null) {
      _data = [];
      json["data"].forEach((v) {
        _data.add(GetDoctorFromSearchModelData.fromJson(v));
      });
    }
    _status = json["status"];
...
class GetDoctorFromSearchModelData {
  int _id;
  String _name;
  String _username;
  String _email;
  ...
  GetDoctorFromSearchModelData.fromJson(dynamic json) {
    _id = json["id"];
    _name = json["name"];
