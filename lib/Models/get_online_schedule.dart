...
class GetOnlineSchedule {
  List<GetOnlineScheduleData> _data;
  bool _status;
  int _success;
  String _message;

  List<GetOnlineScheduleData> get data => _data;
  bool get status => _status;
  int get success => _success;
  String get message => _message;

  GetOnlineSchedule({
      List<GetOnlineScheduleData> data,
      bool status, 
      int success, 
      String message}){
    _data = data;
  ...
  GetOnlineSchedule.fromJson(dynamic json) {
    if (json["data"] != null) {
      _data = [];
      json["data"].forEach((v) {
        _data.add(GetOnlineScheduleData.fromJson(v));
      });
    }
    _status = json["status"];
...
/// serial_day : "4"
/// duration : "20"
/// serial_or_slot : ["09:00:am","09:20:am","09:40:am"]
/// clinic_id : null
/// type : "online"
/// created_at : "2021-09-24T10:30:05.000000Z"
/// updated_at : "2021-09-24T10:43:22.000000Z"
...
class GetOnlineScheduleData {
  ...
  GetOnlineScheduleData.fromJson(dynamic json) {
    _id = json["id"];
